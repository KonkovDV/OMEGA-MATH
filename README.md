...
├── protocol/                          # Ключевые операционные документы исследования
├── research/                          # Core planning surfaces + active/completed workspaces
├── docs/
│   ├── research/                      # Дополнительные research/evidence surfaces
...
See `research/OMEGA_6_PHASE_EXECUTION_PLAN_2026_04_05.md` for full phase-level tasks and acceptance criteria.
